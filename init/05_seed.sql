...
-- Contraseñas hasheadas con bcrypt (valor: "Test1234!")
-- En producción Clerk maneja el hash; esto es solo para pruebas directas en DB
...
-- Identidades (LOCAL para pruebas, sin password_hash real ya que Clerk maneja auth)
-- Nota: para pruebas directas de DB se usa un hash placeholder
...
-- ============================================================
--  VIAJE DE PRUEBA (creado manualmente, sin usar fn_create_trip
--  para mantener el seed simple y predecible)
-- ============================================================

INSERT INTO trips (
    trip_id, user_id, destination_id, trip_name,
    start_date, end_date, status, total_budget, currency
)
SELECT
    ...
    2000.00,
    'USD'
FROM destinations WHERE city = 'Tokio'
LIMIT 1;

-- Días del viaje (8 días)
...
-- ============================================================
--  NOTIFICACIÓN DE BIENVENIDA DE PRUEBA
-- ============================================================
